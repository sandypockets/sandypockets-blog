...
export const meta = {
  ...
  description: 'It comes down to flexibility, and the developer experience.',
  date: 'Jun 28, 2021',
  readTime: 5,
  href: '/blog/why-i-use-tailwind-css',
  id: 3
}

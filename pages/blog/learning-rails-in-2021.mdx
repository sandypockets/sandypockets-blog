...
<div className="flex flex-col">
  Is Rails still worth learning today? Isn’t it an antiquated framework, nearing the end of its lifecycle?
  <br/>
  <br/>
  ...
  <br/>
  <br/>
  One of Rails’ biggest benefits is its convention or customization principle. To me, Rails feels like the Apple ecosystem of programming—everything just works. While there’s certainly a lot going on under the hood, the first few times you use Rails you can’t disagree that it feels a bit like magic. As a developer working alone, this convention is hugely valuable. I can spend my time building out features, and getting a working and presentable prototype up in a couple of days. My time is limited, and I feel Rails recognizes and caters to that.
  <br/>
  <br/>

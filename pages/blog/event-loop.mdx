...
<img src={`https://miro.medium.com/proxy/1*S135MvX52LGtuzTOk42xog.png`} alt={'image'} className='w-3/4 md:w-1/2 m-auto'/>
...
<img src={`https://miro.medium.com/proxy/1*p-zAKFQ4-a_QeOfJxJYWZg.png`} alt={'image'} className='w-3/4 md:w-1/2 m-auto'/>
...
<img src={`https://miro.medium.com/proxy/1*1QlOmynrXczdap_xi9xsaA.png`} alt={'image'} className='w-3/4 md:w-1/2 m-auto'/>
...
<img src={`https://miro.medium.com/proxy/1*hJVLYKO1syPLs_YhPI6p6w.png`} alt={'image'} className='w-3/4 md:w-1/2 m-auto'/>
...
<img src={`https://miro.medium.com/proxy/1*t-h8XxrrH4IxeUTp5Bh1vQ.png`} alt={'image'} className='w-3/4 md:w-1/2 m-auto'/>
...
<img src={'https://miro.medium.com/proxy/1*t2C3POw3ETqZH59TA2H-lA.jpeg'} className='w-3/4 md:w-1/2 m-auto'/>
